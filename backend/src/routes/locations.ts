...
router.get('/zone-users/:zoneId', authenticate, requireRole(['admin', 'security', 'responder']), getUsersInZone);
router.get('/active-users/:propertyId', authenticate, requireRole(['admin', 'security', 'responder']), getAllActiveLocations);
